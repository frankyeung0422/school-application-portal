#!/usr/bin/env python3
"""
Import comprehensive list of Hong Kong primary schools
"""
...
def import_comprehensive_primary_schools():
    """Import comprehensive list of Hong Kong primary schools"""
    
    print("Importing comprehensive list of Hong Kong primary schools...")
    
    # Comprehensive list of Hong Kong primary schools
    primary_schools = [
        ...
        # Additional well-known primary schools
        {
            "school_no": "PS014",
    ...
    try:
        ...
        # Clear existing primary schools to avoid duplicates
        cursor = db_manager.conn.cursor()
        cursor.execute('DELETE FROM primary_schools')
        db_manager.conn.commit()
        print("✅ Cleared existing primary school data")
        ...
        print(f"📊 Database now contains {imported_count} primary school records")
        
        # Verify the import
        cursor.execute('SELECT COUNT(*) FROM primary_schools')
        count = cursor.fetchone()[0]
        print(f"✅ Verified: {count} primary schools in database")
        
        # Show sample data
        cursor.execute('SELECT name_en, district_en FROM primary_schools LIMIT 5')
...
def main():
    """Main function"""
    print("🚀 Starting import of comprehensive primary school data...")
    print("=" * 70)
    
    import_comprehensive_primary_schools()
    
    print("\n" + "=" * 70)
    print("✅ Import completed!")
    print("\nYour database now contains a comprehensive list of primary schools.")
