-- Fix RLS policies and insert all 20 primary schools into Supabase
-- Run this in the Supabase SQL Editor

-- Step 1: Fix RLS policies for primary_schools table
...
DROP POLICY IF EXISTS "Allow service role full access to primary schools" ON public.primary_schools;
...
-- Step 3: Insert all 20 primary schools
